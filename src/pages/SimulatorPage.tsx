  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-1 overflow-hidden gap-0">
        ...
        {/* 우측 안내 패널 */}
        <div className="w-64 flex-shrink-0 p-4 flex flex-col gap-4 bg-gray-50 overflow-y-auto">
          <div>
            <h3 className="text-xs font-bold text-gray-600 uppercase tracking-wide mb-2">사용 방법</h3>
            <ul className="space-y-2 text-xs text-gray-500">
              ...
              <li className="flex gap-1.5"><span>4.</span><span>"연타 전송"으로 스팸 레이아웃을 확인합니다</span></li>
