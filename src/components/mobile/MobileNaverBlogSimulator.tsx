...
export function MobileNaverBlogSimulator({ emoticons }: Props) {
    ...
    <div className="flex flex-col h-[100dvh] overflow-hidden bg-white">
      ...
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-gray-100 flex-shrink-0">
        ...
        <div className="flex items-center gap-3">
          <button className="text-gray-500 text-xs">이웃</button>
          <span className="text-gray-200 text-xs">·</span>
          <button className="text-gray-500 text-xs">로그인</button>
        </div>
      </div>
        ...
        <div className="px-4 py-4 flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4 text-xs text-gray-400">
            <div className="flex items-center gap-1">
              <span>카테고리:</span>
              <button className="text-gray-600 border border-gray-200 rounded px-2 py-0.5 text-xs">전체보기 ▾</button>
            </div>
          ...
          <div className="flex items-center gap-4 py-3 border-t border-b border-gray-100 text-sm text-gray-500">
            ...
            <span className="text-gray-200">|</span>
            <button className="flex items-center gap-1.5"><span>↗</span><span>공유</span></button>
          </div>
